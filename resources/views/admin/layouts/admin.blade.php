        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('list-danh-muc')}}">Danh Sách</a>
                    <a class="collapse-item" href="{{route('danh-sach-san-pham')}}">Sản Phẩm</a>
                    <a class="collapse-item" href="{{route('list-don-hang')}}">Danh Sách Order</a>
                    <a class="collapse-item" href="{{route('list-carousel-slide')}}">Carousel slide</a>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Chọn logout để trở về trang chủ</div>
